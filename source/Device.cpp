 ...
 */
uint32_t
VulkanDevice::getMemoryType (uint32_t typeBits,
 ...
 */
uint32_t
VulkanDevice::getQueueFamilyIndex (VkQueueFlagBits queueFlags) const
{
 ...
 */
VkResult
VulkanDevice::createBuffer (VkBufferUsageFlags usageFlags,
                            ...
                            const void* data)
{
  ...
  VK_CHECK_RESULT (vkCreateBuffer (
    logicalDevice, &bufferCreateInfo, nullptr, &buffer->buffer));
 ...
 */
void
VulkanDevice::copyBuffer (VulkanBuffer* src,
                          VulkanBuffer* dst,
                          VkQueue queue,
 ...
 */
VkCommandPool
VulkanDevice::createCommandPool (uint32_t queueFamilyIndex,
 ...
 */
VkCommandBuffer
VulkanDevice::createCommandBuffer (VkCommandBufferLevel level,
                                   VkCommandPool pool,
                                   bool begin)
{
...
VkCommandBuffer
VulkanDevice::createCommandBuffer (VkCommandBufferLevel level, bool begin)
{
 ...
 */
void
VulkanDevice::flushCommandBuffer (VkCommandBuffer commandBuffer,
                                  VkQueue queue,
                                  VkCommandPool pool,
                                  bool free)
{
  ...
  VK_CHECK_RESULT (vkWaitForFences (
    logicalDevice, 1, &fence, VK_TRUE, std::numeric_limits<uint64_t>::max ()));
 ...
 */
bool
VulkanDevice::extensionSupported (std::string extension)
{
 ...
 */
VkFormat
VulkanDevice::getSupportedDepthFormat (bool checkSamplingSupport)
{
